...
<span style="color:red">**For MK3.5/3.9/4/CoreOne you cannot use single print profile. You MUST use use the
...
only works for Prusa printers with an MMU. Supports MK3s/3.5/3.9/4/CoreOne MMU3 firmware  `3.X.X`.
...
### MK3.5/3.9/4/CoreOne MMU 3.X.X - Single Print
...
### MK3.5/3.9/4/CoreOne MMU 3.X.X - MMU State Detection
...
- `MACHINE_TYPE:Prusa-(MK3\.5|MK3\.9|MK4|COREONE)` - Used to detect if the printer is an MK3.5/3.9/4.
